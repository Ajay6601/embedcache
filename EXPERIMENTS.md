...
Generated 2026-07-10 08:58 EDT · windows/amd64 · 16 CPUs · Go go1.26.5 · mock upstream on loopback
...
|---|---|---|---|
| direct to mock upstream | 0.00 | 0.56 | 5.16 |
| proxy, cache hit | 0.00 | 0.55 | 0.77 |
| proxy, cache miss (adds one upstream hop) | 0.53 | 0.66 | 1.09 |
...
Sustained cache-hit throughput, 32 concurrent clients, 5s: **61060 req/s**.

- **PASS** — hit overhead under 5ms p50: hit adds 0.00 ms at p50
- **PASS** — throughput sane: 61060 cache-hit req/s on loopback
